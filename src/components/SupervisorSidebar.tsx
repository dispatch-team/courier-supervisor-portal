...
export function SupervisorSidebar() {
  ...
  return (
    ...
    >
      {/* Header / Logo */}
      <div className="flex items-center px-4 py-0 h-32 mb-2 overflow-hidden">
        <AnimatePresence mode="wait">
          {!isCollapsed ? (
            ...
            >
              <img src={dispatchIcon.src} alt="Dispatch Icon" className="h-12 w-12 object-contain drop-shadow-[0_0_15px_hsl(270,70%,60%,0.2)]" />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
